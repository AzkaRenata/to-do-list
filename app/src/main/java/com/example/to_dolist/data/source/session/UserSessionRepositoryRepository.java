package com.example.to_dolist.data.source.session;
...
public class UserSessionRepositoryRepository implements com.example.to_dolist.data.source.session.SessionRepository<User> {
