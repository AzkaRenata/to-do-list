package com.example.to_dolist.data.source.local;
...
public class TaskTableHandler implements com.example.to_dolist.data.source.local.TableHandler<Task> {
    ...
    public void create(Task task) {
        ...
        values.put(DatabaseContract.FeedTask.COLUMN_TITLE, task.getTask_title());
        values.put(DatabaseContract.FeedTask.COLUMN_DESCRIPTION, task.getTask_description());
    ...
    public void update(Task task) {
        ...
        String[] selectionArgs = { task.getStrId() };
